...
var parallaxInstance = new parallax_js__WEBPACK_IMPORTED_MODULE_3___default.a(scene); // var rellax = new Rellax('.rellax');

var rellax = new rellax__WEBPACK_IMPORTED_MODULE_4___default.a('.rellax', {
  speed: 1,
  center: false,
  wrapper: null,
  round: true,
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  var wow = new wow_js__WEBPACK_IMPORTED_MODULE_1___default.a({
    boxClass: 'wow',
  ...
  const navFixed = jquery__WEBPACK_IMPORTED_MODULE_0___default()("div.header-nav"),
        navHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()('div').height();
  const elemUl = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-nav__run');
  const menuBg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.car-bg');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider-bl').slick({
    dots: true,
    speed: 1200,
    adaptiveHeight: true,
    slidesToScroll: 1,
    ...
    nextArrow: '<div class="slick-next slick-btn-next"><span class="perv-img right"></span></div>' //  responsive: [
    //      {
    //        breakpoint: 1110,
    //        settings: {
    //          // centerMode: true,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ms-1').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c1').slideToggle(900);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("expand");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ms-2').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c2').slideToggle(900);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("expand");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ms-3').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c3').slideToggle(900);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("expand");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ms-4').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c4').slideToggle(900);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("expand");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ms-5').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.c5').slideToggle(900);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("expand");
  }); //  ACARDION
  // Acardion
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.link-consultations').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-1').css('display', 'flex');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.elem').addClass('scroolHidden');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.close-popap').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-1').css('display', 'none');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.elem').removeClass('scroolHidden');
  }); // Popap Form 1
  // Popap Form 2

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.price-btn').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-2').css('display', 'flex');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.elem').addClass('scroolHidden');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.close-popap').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected').css('display', 'none');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.elem').removeClass('scroolHidden');
  }); // Popap Form 2
  // Popap Form 3

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tilda-cursor').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-3').css('display', 'flex');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.elem').addClass('scroolHidden');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.close-popap').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected').css('display', 'none');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.work-slider').slick({
    dots: true,
    speed: 1200,
    adaptiveHeight: true,
    slidesToScroll: 1,
